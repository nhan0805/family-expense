...
- Triển khai: Đã deploy `email-transactions` lên Supabase staging project `gkvhztqoaslarykxxelt` bằng CLI; chưa deploy production, production vẫn qua workflow Git sau khi merge vào `main`.

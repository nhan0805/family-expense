...
- Kiểm thử: `pnpm test` đạt 24/24 file, 100/100 test; `pnpm lint`, `pnpm typecheck`, `pnpm build` và `git diff --check` pass. Build vẫn cảnh báo chunk ExcelJS lớn đã có từ trước.

...
describe('AI dashboard và tìm kiếm',()=>{
  const filters={query:'quần áo',transactionType:'Chi tiêu' as const,status:'Thực tế' as const,purposeIds:['11111111-1111-4111-8111-111111111111'],expenseTypeIds:['22222222-2222-4222-8222-222222222222','33333333-3333-4333-8333-333333333333'],paymentMethodIds:[],amountMin:500000,amountMax:2000000,month:8,year:2026,dateFrom:null,dateTo:null,sort:'date-desc' as const};

...
describe('AI dashboard và tìm kiếm',()=>{
  const filters={query:'sữa',transactionType:'Chi tiêu' as const,status:'Thực tế' as const,purposeId:'11111111-1111-4111-8111-111111111111',expenseTypeId:null,paymentMethodId:null,amountMin:500000,amountMax:2000000,month:8,year:2026,dateFrom:null,dateTo:null,sort:'date-desc' as const};

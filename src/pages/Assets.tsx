...
function GoldRow({
  ...
  return (
    <article className="p-3 sm:p-4">
      <div className="asset-row-main flex flex-wrap items-center gap-x-4 gap-y-2">
        <div className="flex min-w-0 max-w-full flex-1 flex-wrap items-center gap-x-3 gap-y-1 lg:flex-none">

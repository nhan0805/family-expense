...
export function Dashboard() {
  ...
  return (
    <div className="space-y-5">
      ...
      <section className={`grid grid-cols-2 gap-3 ${hasMultiMonthView ? 'xl:grid-cols-6' : 'xl:grid-cols-3'}`} aria-label={en ? 'Financial summary' : 'Tóm tắt tài chính'}>
        ...
        <div className={hasMultiMonthView ? undefined : 'col-span-2 xl:col-span-1'}><Kpi label={en ? 'Net value' : 'Giá trị ròng'} value={selectedIncome - selectedExpense} icon={Scale} tone={selectedIncome >= selectedExpense ? 'emerald' : 'rose'} meta={en ? 'Income minus expenses' : 'Thu nhập trừ chi tiêu'} to={periodFilterLink()} /></div>
        {hasMultiMonthView && <>

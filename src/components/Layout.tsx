import { BookOpen, Gem, House, LogOut, Menu, MoreHorizontal, PiggyBank, Plus, Repeat2, Settings2, Tags, UserRound, UsersRound, WalletCards, WifiOff, X } from 'lucide-react';
